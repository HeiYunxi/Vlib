        ...
        <el-card class="login_card">
          <el-form :model="form" :rules="rules" ref="ruleFormRef" label-width="80px">
            ...
            <el-form-item label="角&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;色:">
              <el-select v-model="form.type" style="width:300px;"  placeholder="请选择类型" :selected="1">
                <el-option label="后端用户" value="1"></el-option>
                <el-option label="前端用户" value="2"></el-option>
              </el-select>
            </el-form-item>
            <el-form-item>
