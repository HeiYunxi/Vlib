...
export default {
    login, getUserList, saveUser, delUser, getUserDetail,updateUser,register,getRoleList,saveRole,updateRole,delRole,getRoleDetail,saveMenu,getMenuDetail,getMenuList,delMenu,updateMenu,getRoleMenu,saveRoleMenu,getRoleMap,getUserRoleMap,saveUserRole,getMenuAll,getUserMenu
}