        ...
        <el-container class="home-container">
                    ...
                    <el-col :offset="12" :span="8" style="min-width: 150px">
                        <el-dropdown style="float: right; margin: 20px 10px">
                            <span class="el-dropdown-link" style="color: #fff; cursor: pointer">
                                全能君 &nbsp;&nbsp; <el-icon class="el-icon--right">
                                    <arrow-down />
                                </el-icon>
                            </span>
                            <template #dropdown>
            ...
            <!--            <el-menu-item index="/index" @click="saveActiveNav('/index')">
                        ...
                        <el-sub-menu v-if="item.children" :index="item.id">
                          ...
                          <div v-for="childrenItem in item.children">
                            <el-sub-menu v-if="childrenItem.children" :index="childrenItem.id">
                              ...
                              <el-menu-item v-for="childrenItem1 in childrenItem.children" :index="childrenItem1.id" @click="saveActiveNav(childrenItem1.id)">{{ childrenItem1.label }}</el-menu-item>
                            </el-sub-menu>
                ...
                <el-container>
                    ...
                    <el-footer>Copyright © 2022 中国技术</el-footer>
                </el-container>
            </el-container>
        </el-container>
    </div>
...
// 挂载 DOM 之前
onBeforeMount(async() => {
  const res = await userApi.getUserMenu({userId:route.query.userId});
