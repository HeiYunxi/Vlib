...
import com.cqupt.common.Constant;
import com.cqupt.common.MD5Utils;
import com.cqupt.common.TokenUtil;
...
public class LoginController {
    ...
    @ResponseBody
    @PostMapping("/login")
    public Object login(@RequestBody UserEntity user, HttpSession session) {
        ...
        //用户账户密码验证
        UserEntity userEntity = userService.getUserByLoginInfo(params);
        ...
        if (userEntity != null) {
            ...
            {
                UserEntity userEntity1 = userService.getUserByAccountName(params.get("account").toString());
                if(userEntity1!=null)
                {
                    //获得用户ID
