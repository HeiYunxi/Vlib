  ...
  <div>
    ...
    <el-card>
      ...
      <el-table id="Supplier-table" :data="tableData" border style="width: 100%;margin-top:20px">
        ...
        <el-table-column class="table" id="col" prop="address" label="地址" width="300"/>
        ...
        <el-table-column label="操作" width="430">
          <template #default="scope">
            ...
            <el-button size="small" type="success" plain
                       @click="showEquipmentDialog(scope.row.supplierId)">供应商设备列表
            </el-button>
          </template>
        </el-table-column>
      </el-table>
    ...
    <el-dialog
      ...
      <div slot="footer" class="dialog-footer" style="text-align:center;padding-top: 20px;">
        ...
        <el-button type="primary" @click="handleEquipmentConfirm">确 定</el-button>
      </div>
    </el-dialog>
