<template>
  <div>
    <p>角色管理</p>
    <el-card>
      <el-input style="width:440px" @clear="searchRole" clearable v-model="searchForm.roleName" placeholder="请输入角色"
      ...
      &nbsp;&nbsp;&nbsp;
      <el-button type="primary" @click="() => router.push({ path: '/role/save', query: { userId:''} })">新增角色
      </el-button>
        ...
        <el-table-column label="操作" width="530">
          <template #default="scope">
            ...
            <el-button size="small" type="primary"
                       @click="() => router.push({ path: '/role/detail', query: { roleId: scope.row.roleId } })">角色详情
            </el-button>
            <el-button size="small" type="success"
                       @click="() => router.push({ path: '/role/detail', query: { roleId: scope.row.roleId,edit:1 } })">
              编辑角色
            </el-button>
            <el-button size="small"
                       @click="showDialog(scope.row.roleId)">编辑角色菜单
            </el-button>
            <el-button size="small" type="success" plain
                       @click="showUserDialog(scope.row.roleId)">角色用户列表
            </el-button>
          </template>
        </el-table-column>
      </el-table>
    ...
    >
      <div style="text-align:left;">
        <el-table :data="userTableData" border style="width: 100%;margin-top:20px"
